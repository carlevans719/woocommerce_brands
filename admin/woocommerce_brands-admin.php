 ...
 * @subpackage Woocommerce_Brands/admin
 */
 ...
 */
class Woocommerce_Brands_Admin {
	 ...
	 *
	 * @since    0.1.0
	 * @param      string    $Woocommerce_Brands       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->Woocommerce_Brands, plugin_dir_url( __FILE__ ) . 'css/woocommerce_brands-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->Woocommerce_Brands, plugin_dir_url( __FILE__ ) . 'js/woocommerce_brands-admin.js', array( 'jquery' ), $this->version, false );
